...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            if results_dic[key][1] in dognames_dic:  # both labels are dogs
                results_dic[key].extend((1, 1))
            else:  # pet is a dog, classifier is not
                results_dic[key].extend((1, 0))  # TODO 4c
        else:
            if results_dic[key][1] in dognames_dic:  # classifier is a dog, pet is not
                results_dic[key].extend((0, 1))  # TODO 4d
            else:  # neither is a dog
                results_dic[key].extend((0, 0))  # TODO 4e
